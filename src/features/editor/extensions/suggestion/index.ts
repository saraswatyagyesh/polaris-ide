    ...
    class {
        ...
        build(view: EditorView) {
            ...
            return Decoration.set([
                Decoration.widget({ widget: new SuggestionWidget(suggestion), side: 1 }).range(cursor),
            ]);
        }
